...
export default function ViewFinalInternalIA() {
  const [selectedCourse, setSelectedCourse] = useState('');

  return (
    <div className="p-8">
      <div className="max-w-4xl">
        <h1 className="text-3xl font-bold text-gray-800 mb-8">View Final IA</h1>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
          ...
          <div className="min-h-[300px] flex items-center justify-center text-gray-400">
            {!selectedCourse ? (
              <p>Please select a course to view final internal IA</p>
            ) : (
              <p>Final IA data will be displayed here</p>
            )}
          </div>
        </div>
