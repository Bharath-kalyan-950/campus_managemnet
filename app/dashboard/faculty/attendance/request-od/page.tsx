...
export default function RequestODPage() {
  ...
  const fetchCourses = async () => {
    try {
      const response = await fetch('/api/faculty/courses/my-courses');
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-600 mt-1">Submit OD requests for official duties and events</p>
          </div>
          <button
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200">
        <div className="p-6 border-b border-slate-200">
          ...
          <p className="text-slate-600 mt-1">Track your submitted OD requests</p>
        </div>
