...
export default function FacultyRaiseIssuePage() {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-200">
        ...
        <div className="space-y-3">
          {[
            { id: 1, issue: 'Projector malfunction in Faculty Room 205', status: 'In Progress', date: '1 day ago' },
            { id: 2, issue: 'AC not working in Conference Hall', status: 'Resolved', date: '3 days ago' },
            { id: 3, issue: 'Whiteboard marker shortage in Lab 3', status: 'Under Review', date: '2 days ago' },
          ].map((item) => (
